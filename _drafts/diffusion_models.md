---
layout: post
title: Diffusion models - what a demon has to do with cute dog images
...
theme_color: '#ccc'
description: >
A guide on how to wrap your head around diffusion models and the impact they already have on biology
invert_sidebar: true
---

# Diffusion models - what a demon has to do with cute dog images
For all criticism that is rightfully aimed at social media, Twitter is able to do something that I did not found anywhere else so far: It brings up the hidden gems that are buried somewhere in the depths of the internet, whether that may be some cool new paper or an amazing tutorial about a topic I find interesting. Latter was what I found when I saw a tweet that mentioned this [tutorial webpage]() dealing with diffusion models, or (to be more specific) stochastic denoising diffusion models. If you have no clue what that is, great - this post is trying to explain that.
The tutorial - which was recorded after it apparently attracted quite some interest at CVPR 2022 - contains much more than I am going to talk about, and I highly recommend you check out the website which has the video and the accompanying slides. For this post I will focus on the general introduction that is roughly the first hour of the video, but may cover more in future posts. Let's dive right into it!
