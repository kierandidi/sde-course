...
$$
\begin{align}
\color{green} -\frac{\partial}{\partial t} [p_s(x_s \mid x_t)] \color{black} p_t(x_t) - p_s(x_s \mid x_t) \color{orange}\frac{\partial}{\partial t} [p_t(x_t)] \color{black} \\ = \color{green} \Big( \mu(x_t) \frac{\partial}{\partial x_t}[p_s(x_s \mid x_t)] + \frac{1}{2} \sigma^2(x_t) \frac{\partial^2}{\partial x_t^2}[p_s(x_s \mid x_t)] \Big) \color{black} p_t(x_t)  \\ + p_s(x_s \mid x_t) \color{orange} \Big( \frac{\partial}{\partial x_t} [\mu(x_t) p_t(x_t)] - \frac{1}{2} \frac{\partial^2}{\partial x_t^2} [\sigma^2(x_t) p_t(x_t)] \Big)\\
\end{align}
$$
