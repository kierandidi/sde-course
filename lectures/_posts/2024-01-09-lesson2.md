...
$$\frac{\partial}{\partial t} p_t(x) = - \frac{\partial}{\partial x}[\mu(x,t)p_t(x)] + \frac{1}{2} \frac{\partial^2}{\partial x^2}[\sigma^2(X_t,t)p_t(x)] + \frac{1}{2} \frac{\partial}{\partial x}[\sigma^2(X_t,t)\frac{\partial p_t(x)}{\partial x}]$$
