...
$$\frac{\partial}{\partial t} p_t(x) = - \frac{\partial}{\partial x}[\mu(x,t)p_t(x)] + \frac{\partial^2}{\partial x^2}[\frac{1}{2}\sigma(x,t)\sigma(x,t)^T p_t(x)]$$
...
$$\frac{\partial}{\partial t} p_t(x) = - \frac{\partial}{\partial x}[\mu(x,t)p_t(x)] + \frac{1}{2} \frac{\partial^2}{\partial x^2}[\frac{1}{2}\sigma(x,t)\sigma(x,t)^Tp_t(x)] + \frac{1}{2} \frac{\partial}{\partial x}[\frac{1}{2}\sigma(x,t)\sigma(x,t)^T\frac{\partial p_t(x)}{\partial x}]$$

Pulling the $$p_t(x)$$ and the $$\frac{\partial}{\partial x}$$ outside the whole expression, we get

$$\frac{\partial}{\partial t} p_t(x) = - \frac{\partial}{\partial x} \big[ \mu(x,t)- \frac{1}{2} \nabla_x [\sigma(x,t)\sigma(x,t)^T] - \frac{1}{2}\frac{1}{2}\sigma(x,t)\sigma(x,t)^T \nabla_x [\log p_t(x)]\big]$$
