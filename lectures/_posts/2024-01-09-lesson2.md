...
Pulling the $$p_t(x)$$ and the $$\frac{\partial}{\artial x}$$ outside the whole expression, we get

$$\frac{\partial}{\partial t} p_t(x) = - \frac{\partial}{\partial x} \big[ \mu(x,t)p_t(x) - \frac{1}{2} \big]$$
