...
Let's start again with our general SDE $$dX_t = \mu(X_t, t)dt + \sigma(X_t, t)dW_t$$. We know that the Focker-Planck Equation of this general SDE is given by

$$\frac{\partial}{\partial t} p_t(x) = - \frac{\partial}{\partial x}[\mu(x,t)p_t(x)] + \frac{\partial^2}{\partial x^2}[D(x,t)p_t(x)]$$
