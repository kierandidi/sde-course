...
&= \frac{1 }{{\textcolor{red}{p_{T \mid s}(z_T=z \mid z_{s})}}} ( p_{t\mid s}(z_{t}\mid z_{s}) \partial_t {\textcolor{red}{p_{T \mid t}(z_T=z \mid z_{t}) }} + {\color{red}p_{T \mid t}(z_T=z \mid z_{t}) }\partial_t p_{t\mid s}(z_{t}\mid z_{s}) ) \hspace{10px} \mid \text{Def. h-transform} \\
