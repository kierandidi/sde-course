...
$$
\begin{align}
-\frac{\partial}{\partial t} p_s(x_s, x_t) &= \mu(x_t) \frac{\partial}{\partial x_t}[p_s(x_s \mid x_t)] + \frac{1}{2} \sigma^2(x_t) \frac{\partial^2}{\partial x^2}[p_s(x_s \mid x_t)] p_t(x_t) - p_s(x_s \mid x_t) \frac{\partial}{\partial t} [p_t(x_t)] \\
\end{align}
$$
