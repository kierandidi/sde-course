...
$$p_{t, t+\delta}(x_{t+\delta}, x_t) = p_{t+\delta \mid t}(x_{t+\delta} \mid x_t) p_t(x_t) = p_{t \mid t+\delta}(x_t \mid x_{t+\delta}) p_{t+\delta}(x_{t+\delta})$$
...
$$
\begin{align}
p_{t+\delta \mid t}(x_{t+\delta} \mid x_t) &= \mathcal{N}(x_{t+\delta} \mid x_t + \mu(x_t, t) \delta t, \sigma^2(x_t, t) \delta t)
p_{t \mid t+\delta}(x_t \mid x_{t+\delta}) &= \mathcal{N}(x_t \mid x_{t+\delta} - \mu(x_{t+\delta}, t+\delta) \delta t, \sigma^2(x_{t+\delta}, t+\delta) \delta t)
\end{align}
$$
...
$$
\begin{align}
p_{t+\delta \mid t}(x_{t+\delta} \mid x_t) p_t(x_t) &= p_{t \mid t+\delta}(x_t \mid x_{t+\delta}) p_{t+\delta}(x_{t+\delta}) \hspace{10px} \mid \text{insert Gaussians}\\
\mathcal{N}(x_{t+\delta} \mid x_t + \mu(x_t, t) \delta t, \sigma^2(x_t, t) \delta t) p_t(x_t) &= \mathcal{N}(x_t \mid x_{t+\delta} - \mu(x_{t+\delta}, t+\delta) \delta t, \sigma^2(x_{t+\delta}, t+\delta) \delta t) p_{t+\delta}(x_{t+\delta}) \hspace{10px} \mid \text{take log}\\
\end{align}
$$
